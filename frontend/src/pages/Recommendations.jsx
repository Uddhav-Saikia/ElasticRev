  ...
  <h1 className="text-3xl font-bold text-gray-100">Pricing Recommendations</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="card bg-red-50">
          ...
          <p className="text-sm text-gray-500 mt-1">&gt;10% revenue impact</p>
        </div>
        <div className="card bg-yellow-50">
          ...
          <p className="text-sm text-gray-500 mt-1">5-10% revenue impact</p>
        </div>
        <div className="card bg-green-50">
          ...
          <p className="text-sm text-gray-500 mt-1">&lt;5% revenue impact</p>
        </div>
      </div>
